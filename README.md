...
You may use any programming language unless a question specifies otherwise. You are not expected to have prior knowledge of NASA, remote sensing, geographic information systems or any particular scientific dataset. Any information required to answer a question will be given. 
...
The program should be runnable by another developer.

If a section is incomplete when the time ends, submit the work completed and state briefly what remains unfinished.

---

End of PaperNSAC ENGINEERING TEST

Technical Problem Paper
...
You may use official documentation for programming languages, libraries, APIs and other software tools.

You must work independently. Generative AI and AI-assisted programming tools are not permitted.

You may use any programming language. Python is permitted.

You are not expected to have prior knowledge of NASA, remote sensing, geographic information systems or any particular scientific dataset. Any information required to answer a question will be given.

Where a question asks for a program, write working code.

Where a question asks for an explanation, give a clear reason.

If information is insufficient to determine an answer, state what additional information would be required.
